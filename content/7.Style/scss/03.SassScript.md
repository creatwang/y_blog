...
> 当一个css属性值为 null 的时候，不会编译成css，多用于逻辑判断
...
~~~scss
@function fn-name($params1, $params2) {
...
![image-20200707171035353](../../../assets/markdown/assets/sources_scss/image-20200707171035353.png)
